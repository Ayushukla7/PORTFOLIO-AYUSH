      ...
      >
        ...
        <MagneticHover padding={100} disabled={false} magnetStrength={50}>
          <div className="bg-[#E9C3B8] flex text-black justify-center items-center p-6 min-h-[35rem]">
            <Projects
              img="/assets/vacciss.png"
              name="VacciTrack"
              desc="A simple web app to track your vaccination status."
              href1="https://vaccitrackv2-view.onrender.com/"
              href2="https://github.com/Ayushukla7/VacciTrackV2.git"
            />
          </div>
        </MagneticHover>
        ...
        <MagneticHover padding={100} disabled={false} magnetStrength={50}>
          <div className="bg-[#224A54] text-white flex justify-center items-center p-6 min-h-[35rem]">
            <Projects
              img="/assets/SMARTCLUBOS.png"
              name="Smart Club OS"
              desc="A modern operating system for the Smart Club."
              href1="https://smart-club-os.vercel.app/"
              href2="https://github.com/Ayushukla7/Smart-Club-OS.git"
            />
          </div>
        </MagneticHover>
