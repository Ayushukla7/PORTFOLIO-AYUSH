...
import { FaLinkedin, FaInstagram, FaLocationDot, FaDiscord } from "react-icons/fa6";
    ...
    >
      ...
      >
        ...
        <div className="flex xs: justify-center lg:justify-end  lg:absolute lg:right-28 lg:top-[45%] gap-5 sm:mt-0">
          <a href="https://github.com/Ayushukla7" target="_blank">
            <IoLogoGithub color="white" size="40" />
          </a>
          <a href="https://www.instagram.com/ayushs_4141/" target="_blank">
            <FaInstagram color="white" size="40" />
          </a>
          <a
            href="https://www.linkedin.com/in/ayushshukla41/"
            target="_blank"
          >
            <FaLinkedin color="white" size="40" />
          </a>
          <a
            href="https://www.discord.com/users/ayushshukla4141"
            target="_blank"
          >
