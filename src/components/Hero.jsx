...
import me from "/assets/ayushport.png";
  ...
  return (
    ...
    >
      <div className="flex-1 text-center sm:text-left">
        ...
        <SplitText
          text="Ayush"
          className="text-6xl sm:text-6xl lg:text-7xl font-[630] leading-tight mb-8"
          delay={100}
        ...
        <div className="flex flex-col sm:flex-row gap-4 mx-1 mt-6 justify-center sm:justify-start">
          <a
            href="https://drive.google.com/file/d/1YAj6igaJRwjEq5GCB4MtSGIYdbhgo-97/view?usp=sharing"
            target="_blank"
          >
          ...
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=nitianayush4141@gmail.com&su=Let's Connect&body=Hi, I wanted to reach out regarding..."
            target="_blank"
